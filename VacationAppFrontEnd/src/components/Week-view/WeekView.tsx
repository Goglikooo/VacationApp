...
export default function WeekView({
  ...
  return (
    <section className="flex flex-col gap-3 rounded-lg border border-vacation/30 bg-vacation-bg/30 border-l-4 border-l-vacation p-3 text-card-foreground shadow-sm">
      ...
      <div className="grid grid-cols-7 gap-1.5 border-t border-vacation/20 pt-3">
        {days.map((day) => (
          <Button
            ...
            className={`flex h-auto min-w-0 flex-col gap-0.5 rounded-md border py-2 cursor-pointer
 ${
